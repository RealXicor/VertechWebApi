...
namespace Assignment2.Server.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        {
            var options = new DbContextOptionsBuilder<DatabaseContext>().UseSqlServer("Data Source=DESKTOP-SB4HEO9;Initial Catalog=VertechWebApiDB;Trusted_Connection=true;TrustServerCertificate=True;").Options;
        ...
        public IActionResult Get()
        {
            ...
            var searchedProduct = _context.Product.ToList();
